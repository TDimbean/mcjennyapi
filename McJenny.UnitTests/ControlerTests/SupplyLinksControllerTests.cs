...
{
    [TestClass]
    public class SupplyLinksControllerTests
    {
        ...
        {
            var supplyLinks = FakeRepo.SupplyLinks;
            ...
            var linksDbSetMock = dbContextMock.CreateDbSetMock(x => x.SupplyLinks, supplyLinks);
            var supsDbSetMock = dbContextMock.CreateDbSetMock(x => x.Suppliers, suppliers);
            var catsDbSetMock = dbContextMock.CreateDbSetMock(x => x.SupplyCategories, supplyCategories);
            var locsDbSetMock = dbContextMock.CreateDbSetMock(x => x.Locations, locations);
