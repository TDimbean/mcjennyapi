...
namespace McJenny.UnitTests.ControlerTests.InMemoryDbVersions
{
    ...
    public class MenuItemControllerTests
    {
        ...
        //[TestMethod]
        //public async Task GetMenuItemLocations_HappyFlow_ShouldReturnLocations()
        //{
        //    // Arrange
        //    var menuId = (await _context.MenuItems.FindAsync(GetFirstMenuItemId)).MenuId;

        //    var strings = await _context.Locations
        ...
        //    // Act
        //    var result = (object)(await _controller
        //        .GetMenuItemLocations(GetFirstMenuItemId)).Value;
        ...
        //[TestMethod]
        //public async Task GetMenuItemLocations_InexistentId_ShouldReturnNotFound()
        //{
        //    // Act
        //    var result = (object)(await _controller
        //        .GetMenuItemLocations(GenBadMenuItemId)).Result;
