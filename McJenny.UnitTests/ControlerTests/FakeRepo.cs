...
namespace McJenny.UnitTests.ControlerTests
{
    public static class FakeRepo
    {
        ...
        public static List<DishRequirement> DishRequirements = new List<DishRequirement>
            {
                //Apple Pie
        ...
        public static List<Location> Locations = new List<Location>
            {
                ...
                new Location{ LocationId = 4 , AbreviatedCountry="IT", AbreviatedState="LZ", City="Roma", State="Lazio",
                    OpenSince=new DateTime(2017, 3 , 20), MenuId=1, ScheduleId=1, Street="32 Apple Boulepublic static List<>d", Country="Italy"},
            };

        public static List<Management> Managements = new List<Management>
            {
        ...
        public static List<SupplierStock> SupplierStocks = new List<SupplierStock>
            {
        ...
        public static List<SupplyLink> SupplyLinks = new List<SupplyLink>
            {
        ...
        public static List<SupplyCategory> SupplyCategories = new List<SupplyCategory>
            {
